        ...
        <div class="container px-2 px-lg-2   mt-2">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="content-wrapper">
                    ...
                    @endif
                    <h4 class="fw-bold py-3 mb-4">Form Tambah Kategori</h4>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.category.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="basic-default-fullname" name="category_name" placeholder="Parachute Jacket" />
                                        </div>
                                        <div class="mb-3">
